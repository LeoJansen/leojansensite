...
export function Avatar({animation = "thoughtful",  ...props}) {
  const [screenState, setScreenState] = useState({position:props.position, rotation:props.rotation, scale:props.scale});
  ...
  return (
    <group {...props} ref={group} dispose={null} position={screenState.position} rotation={screenState.rotation} scale={screenState.scale}>
